...
const Footer = () => {
    return (
      <>
        <footer className="tc-l bg-black">
          <h1 className=" pt-4 f4 text-center text-white">
            Copyright 2021 @ Deepesh arya
          </h1>
          <div className="w-100 bg-black-50 text-center">
            <a
            ...
            <a
              className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2"
              href="https://github.com/deep1205"
              title="GitHub"
            >
              <svg
                className="dib h2 w2"
            ...
            <a
              className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2"
              href="https://www.instagram.com/_deepesh.arya/"
              title="Instagram"
            >
              <svg
                className="dib h2 w2"
            ...
            <a
              className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2"
              href="https://www.linkedin.com/in/deepesh-arya-1a9aaa171/"
              title="LinkedIn"
            >
              <svg
                className="dib h2 w2"
            ...
            <a
              className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2"
              href="shttps://twitter.com/Deepesh67158855"
              title="Twitter"
            >
              <svg
                className="dib h2 w2"
